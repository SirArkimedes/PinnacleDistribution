...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        // @JONAS - Need to change this so that when COD is selected in our DB the database enteres that the order is payed so shipstation will enter properly 
        ...
        public virtual IActionResult SelectPaymentMethod(string paymentmethod, CheckoutPaymentMethodModel model)
        {
            ...
            if (paymentMethodInst == null ||
                ...
                return PaymentMethod();
            // @JONAS - this may be where I need to update changes based on wether the user has selected COD ( cash on delivery )
            //save
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
