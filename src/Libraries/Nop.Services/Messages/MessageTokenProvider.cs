    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected Dictionary<string, IEnumerable<string>> AllowedTokens
        {
            get
            {
                ...
                //customer tokens
                // @JONAS : I am adding  a few more tokens here so that I can add more fields 
                //    for the user to be added to the newly added customer email
                _allowedTokens.Add(TokenGroupNames.CustomerTokens, new[]
                {
                    ...
                    // @JONAS Trying to add the Custom CustomerAttributes so I can use them in a message template. 
                    //"%CustomerAttribute.Sales Rep.%",
